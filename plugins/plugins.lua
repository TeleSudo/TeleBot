...
local function list_all_plugins(only_enabled)
  ...
  for k, v in pairs( plugins_names( )) do
    ...
    if not only_enabled or status == '☑️' then
      ...
      text ='<i>'..text..nsum..'</i>. <b>'..v..'</b>  '..status..'\n'
    end
  end
  local text = text..'\n<b>There are</b> <b>'..nsum..'</b> <b>plugins installed.</b>\n<b>'..nact..'</b> <b>plugins enabled and</b> <b>'..nsum-nact..'</b> <b>disabled</b>'
  return text
end
...
local function run(msg, matches)
  ...
  if matches[1] == '+' and matches[3] == 'chat' and is_sudo then
